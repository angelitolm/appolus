...
import LoadingSmallListTickets from './LoadingSmallListTickets'
...
const SamallListTickets = history => {
  // ===============================================================
  // Hooks useState
  // ===============================================================
  ...
  if (loading)
    return <LoadingSmallListTickets />
            ...
            {tickets.map(ticket => {
              ...
              <div className="kt-widget3__item" key={ticket._id}>
                ...
                <div className="kt-widget3__body">
                  <h6 className="kt-widget3__text"><Link to={`/app/tickets/details/${ticket._id}`}>{ticket.title}</Link></h6>
